...
class RespuestaService:
    ...
    @staticmethod
    def create_respuesta(descripcion: str, id_pregunta: int, creador:str) -> common.Respuesta:
    ...
    @staticmethod
    def create_respuesta_from_common(respuesta: common.Respuesta, id_pregunta: int) -> common.Respuesta:
        return RespuestaService.create_respuesta(respuesta.getDescripcion(), id_pregunta, respuesta.getCreador())
    ...
    @staticmethod
    def list_respuestas(id_pregunta: int) -> List[common.Respuesta]:
        out: List[common.Respuesta] = []
        session: Session = Schema.new_session()
        respuestas: List[Respuesta] = Respuestas.list_all(session)
        for respuesta in respuestas:
    ...
    @staticmethod
    def get_respuesta(id : int) -> common.Respuesta:
        session : Session = Schema.new_session()
